    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-white border-b">
            <div class="max-w-5xl mx-auto px-6 py-6 flex justify-between items-center">
                <div>
                    <h1 class="text-4xl font-bold text-emerald-700">RMETI</h1>
                    <p class="text-gray-600">Rocky Mountain Electrical Training Institute</p>
                </div>
                <div>
                    <img src="https://www.rmeti.com/wp-content/uploads/2023/01/rmeti-logo.png" 
                         alt="RMETI Logo" class="h-14">
                </div>
            </div>
        </div>

        <!-- Login Form -->
        <div class="max-w-lg mx-auto mt-16 px-6">
            <div class="bg-white p-12 rounded-3xl shadow-xl border">
                <h2 class="text-5xl font-semibold mb-10 text-center">Login</h2>
                
                <form method="POST" class="space-y-8">
                    <div>
                        <label class="block text-xl mb-3 text-gray-700 font-medium">I am a</label>
                        <select name="role" id="role" class="w-full border border-gray-300 rounded-2xl px-8 py-5 text-2xl" onchange="togglePassword()">
                    ...
                    <div>
                        <label class="block text-xl mb-3 text-gray-700 font-medium">Email or Username</label>
                        <input type="text" name="identifier" required 
                               class="w-full border border-gray-300 rounded-2xl px-8 py-5 text-2xl">
                    </div>

                    <div id="passwordField" style="display: none;">
                        <label class="block text-xl mb-3 text-gray-700 font-medium">Password</label>
                        <input type="password" name="password" 
                               class="w-full border border-gray-300 rounded-2xl px-8 py-5 text-2xl">
                    </div>

                    <button type="submit" 
                            class="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-6 rounded-2xl text-2xl font-semibold mt-4">
                        Login
                    </button>
                </form>
            </div>
            ...
            <div class="mt-8 text-center">
                <a href="/register_instructor" class="text-emerald-600 hover:underline text-xl">Register as Instructor</a>
            </div>
        </div>
    </div>
