...
# ==================== INSTRUCTOR DASHBOARD (Grouped by Program) ====================
...
def instructor_dashboard():
    ...
    for program_name, student_list in programs.items():
        html += f"""
        <div class="mb-10">
            <h3 class="text-2xl font-semibold mb-4 text-emerald-700">{program_name}</h3>
        """
        ...
        for s in student_list:
            ...
            if grades:
                html += """
                <div class="mt-4">
                    <h5 class="font-medium mb-2 text-gray-700">Previous Records</h5>
                ...
                for g in grades:
                    html += f"""
                        <tr class="border-b">
                            <td class="py-2">{g['module_name'] or '-'}</td>
                            <td>{g['grade'] or '-'}</td>
                ...
                html += "<p class='text-gray-500 text-sm mt-2'>No records yet for this student.</p>"
