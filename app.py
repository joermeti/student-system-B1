...
# ====================== CONFIG ======================
INSTRUCTOR_PASSWORD = "rmeti2026"   # ← Change this to your desired password
# ====================================================
...
# ==================== LOGIN (with password for instructors only) ====================
...
def login():
    if request.method == "POST":
        ...
        # Instructor password check
        if role == "instructor":
            if password != INSTRUCTOR_PASSWORD:
                flash("Incorrect instructor password.")
        ...
        <form method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="identifier" required 
                       class="w-full border border-gray-300 rounded-2xl px-5 py-4 text-lg">
            </div>

            <div id="passwordField" style="display: none;">
                <label class="block text-sm mb-2 text-gray-600 font-medium">Password (Instructors only)</label>
                <input type="password" name="password" 
                       class="w-full border border-gray-300 rounded-2xl px-5 py-4 text-lg">
            </div>

            <button type="submit" 
                    class="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-4 rounded-2xl text-lg font-medium mt-2">
                Login
            </button>
        </form>
    </div>
    ...
    <script>
        function togglePassword() {
            ...
            passwordField.style.display = (role === 'instructor') ? 'block' : 'none';
        }
