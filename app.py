...
def student_dashboard():
    ...
    if grades:
        ...
        html += "<p class='text-gray-500 italic text-base'>No grades recorded yet.</p>"
    html += "</div>"
    ...
    for s in students:
        ...
        <div class="bg-white border border-gray-200 rounded-2xl p-8 mb-10 shadow-sm">
            ...
            <form method='POST' class="flex flex-col md:flex-row gap-4 bg-emerald-50 p-5 rounded-xl mb-6 items-end border border-emerald-100">
                ...
                <button type='submit' class='btn-green py-2 px-6 text-base w-full md:w-auto mb-1'>+ Add Record</button>
            </form>
        """
